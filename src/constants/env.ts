...
export const COOKIE_DOMAIN = '.cmail.network'

export const DISCORD_URL = 'https://discord.gg/equB6RTCHR'

export const TWITTER_URL = 'https://twitter.com/mail3dao'

export const WHITE_LIST_DOC_URL = '#'


export const MORE_DETAILS_LINK = 'https://feather-amaryllis-11e.notion.site/Mail3-Beta-Access-43c1bf8f21ff443ca3ca4b6f1119e0b8'

export const IMAGE_PROXY_URL = 'https://mail3.me/api/image-proxy?url='
...
export const DRIFT_BOTTLE_ADDRESS = `driftbottle.eth@mail3.me`


export const GITHUB_URL = 'https://github.com/mail3protocol'

export const GITHUB_MAIL3_ME_BUTTON_URL = 'https://github.com/mail3protocol/mail3-me-button'

export const MIRROR_URL = 'https://mirror.xyz/mail3.eth'

export const MAIL3_ME_BUTTON_MIRROR_URL = 'https://mirror.xyz/mail3.eth/nTiZI4w3vB1BBjwc8ZLUHCJ2FPhaYJd-l7v62Tv_FY0'
...
export const PRODUCT_RECOMMENDATIONS_ADDRESS = 'oxyful.eth@mail3.me'

export const PRODUCT_RECOMMENDATIONS_SUBJECT = '[Product suggestion] It would be terrific if …'
